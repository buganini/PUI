...
|-------|-------|----|-------|-------|
|Application|QApplication|Page|TkApplication|TApplication|
|Window|QMainWindow|✓|TkWindow|TWindow|
|HBox|QHBoxLayout|Row|TkHBox|THorizontal|
|VBox|QVBoxLayout|Column|TkVBox|TVertical|
|Spacer|QSpacerItem|✓|TkSpacer|TSpacer|
|Label|QLabel|Text|TkLabel|TLabel|
|Button|QPushButton|ElevatedButton|TkButton|TButton|
|Checkbox|QCheckBox|Checkbox|TkCheckbutton|TCheckbox|
|RadioButton|QRadioButton|Radio|TkRadiobutton|TRadioButton|
|Canvas|✓(QWidget)|Canvas|TkCanvas|-|
|TextField|QLineEdit|TextField|TkEntry|TInput|
|ProgressBar|QProgressBar|ProgressBar|TkProgressBar|TProgressBar|
|Scroll|QScrollArea|✓|TkScroll|TScroll|
|Text|QLabel|Text|TkText|TText|
|Html|QLabel|Text(!)|-|-|
|MarkDown|QLabel|Markdown|-|-|
|Combobox|QComboBox|-|-|-|
|ComboboxItem|✓|-|-|-|
|Tabs|QTabWidget|Tabs|TkNotebook|TTabs|
|Tab|✓|Tab|TkNotebookFrame|TTab|
|MenuBar|QMenuBar|-|-|-|
|Menu|QMenu|-|-|-|
|MenuAction|QAction|-|-|-|
|MdiArea|QMdiArea|-|-|-|
