...
class TreeAdapterExample(PUIView):
    ...
    def setup(self):
        self.state = State()
        self.state.data = MyTreeNode("Root")

        sub1 = MyTreeNode("Sub1")
        sub1.addChild(MyTreeNode("Sub1.1"))
        sub1_2 = MyTreeNode("Sub1.2")
        sub1_2.addChild(MyTreeNode("Sub1.2.1"))
        sub1_2.addChild(MyTreeNode("Sub1.2.2"))
        sub1.addChild(sub1_2)
        sub1.addChild(MyTreeNode("Sub1.3"))
        self.state.data.addChild(sub1)

        sub2 = MyTreeNode("Sub2")
        self.state.data.addChild(sub2)

        sub3 = MyTreeNode("Sub3")
        sub3.addChild(MyTreeNode("Sub3.1"))
        sub3.addChild(MyTreeNode("Sub3.2"))
    ...
    def add_item(self):
        t = MyTreeNode("New item")
        t.addChild(MyTreeNode("Sub"))
